...
class LocationIndexActorSpec extends TestKit(ActorSystem("LocationIndexActorSpec", TestKitConfig.config))
  ...
  "A LocationIndexActor" must {
    ...
    val point1 = Point("point1", Coordinates(1.0, 2.0, 3.0), "data-1")
    val point2 = Point("point2", Coordinates(2.0, 3.0, 4.0), "data-2")
    val point3 = Point("point3", Coordinates(3.0, 4.0, 5.0), "data-3")
